...
if (!isset($_SESSION['student_id']))
    header('location:index.php');
          ...
          $student_id=$_POST['student_id'];
              ...
              //  print_r($conn);
                 $query="INSERT INTO student(student_id,email,password,userType,name,address,department,cnumber,blood_group,image) VALUES('$student_id','$email','$password','$userType','$name','$address','$department','$cnumber','$blood_group','$targetFile')";
               ...
               if(mysqli_query($conn,$query)){
                   ...
                   echo '<script>alert("Successfully Add Admin!!");location.href="adminList.php"</script>';
...
<div class="features_area section_gap_change">
        ...
        <div class="containerChange">
            ...
            <div class="wrap-contact100">
                    <form class="contact100-form validate-form" method="POST" enctype="multipart/form-data" action="adminAddEdit.php">
                   <!--  <input type="hidden" name="id" value=""> -->

                <div class="wrap-input100 validate-input" >
                    <span class="label-input100"> ID:</span>
                    <input class="input100" type="text" name="student_id" value="" placeholder="Enter id" required>
