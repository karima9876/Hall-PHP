							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->degree}}</h2>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->cnumber}}</h2>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->block}}</h2>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->btype}}</h2>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->birth_date}}</h2>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->gender}}</h2>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->religion}}</h2>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->districts}}</h2>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->blood_group}}</h2>
									</div>
								</div>
				...
				<div class="pictureProfile">
					<div class="card card-profile">
						...
						<div class="card-body">
							...
							<a href="#" class="btn btn-primary btn-round"> {{$particularPro->amount}} taka </a>
							<a href="#" class="btn btn-primary btn-round"> Replies </a>
						</div>
					</div>
				</div>
