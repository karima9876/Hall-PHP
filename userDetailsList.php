...
<div class="social clear">
    <form class="search-post" action="userDetailsListSearch.php" method ="GET">
          ...
          <!--   <div class="col-12Change2">
             ...
             <div class="row">
                  ...
                  if(mysqli_num_rows($result2)){
                    ...
                    if($page_number>1){
                       echo '<li class="page-item"><a class="page-link" href="userDetailsList.php?page='.($page_number-1).'">prev</a></li>';
                    ...
                    for ($i=1; $i <=$total_page ; $i++) { 
                      ...
                      echo '<li class="page-item" class='.$active.'><a class="page-link" href="userDetailsList.php?page='.$i.'">'.$i.'</a></li>';
                      # code...
                    }
                    if($total_page>$page_number){
                    echo '<li class="page-item"><a class="page-link"  href="userDetailsList.php?page='.($page_number+1).'">next</a></li>';
                    echo "</ul>";
                  }
                }
