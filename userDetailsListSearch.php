...
<?php 
    ...
    $uTpe= 'User';
    $query = "select * from student where userType='$uTpe' and department LIKE '%{$search}%' ORDER BY id DESC LIMIT {$offset},{$limit}";
        ...
        <div class="containerChange">
                ...
                while ($row = mysqli_fetch_assoc($result)) { ?>
                    ...
                    <tr>
                       ...
                       <td style="word-wrap: break-word;"><img width="100px" src="<?php echo $row['image'] ?>"/> </td>
                        ...
                        <a onclick="return confirm('Are You Sure?')"href="userDetailsList.php?id=<?php echo $row['id']; ?>">Delete</a>
                        </th>
                    </tr>
                     <?php  ++$i; 
                 } 
            ...
            <div class="row">
                  ...
                  if(mysqli_num_rows($result2)){
                    ...
                    if($page_number>1){
                       echo '<li class="page-item"><a class="page-link" href="userDetailsList.php?search='.$search.'&page='.($page_number-1).'">prev</a></li>';
                    ...
                    for ($i=1; $i <=$total_page ; $i++) { 
                      ...
                      echo '<li class="page-item" class='.$active.'><a class="page-link" href="userDetailsList.php?search='.$search.'&page='.$i.'">'.$i.'</a></li>';
                      # code...
                    }
                    if($total_page>$page_number){
                    echo '<li class="page-item"><a class="page-link"  href="userDetailsList.php?search='.$search.'&page='.($page_number+1).'">next</a></li>';
                    echo "</ul>";
                  }
                }
